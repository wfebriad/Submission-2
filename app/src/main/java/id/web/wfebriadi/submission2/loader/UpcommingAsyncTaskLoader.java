...
public class UpcommingAsyncTaskLoader extends AsyncTaskLoader<ArrayList<FilmItem>> {

    private ArrayList<FilmItem> mData;
    private boolean mHashResult = false;

    public UpcommingAsyncTaskLoader(final Context context, ArrayList<FilmItem> mData){
        super(context);
        onForceLoad();
    }
